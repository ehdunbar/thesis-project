view: masters_hole_stats {
  sql_table_name: golf_stats.Masters_Hole_Stats ;;
  ...
  dimension: seasons__year {
    type: number
    sql: cast(case when (${TABLE}.seasons__year) = "NA" then null else ${TABLE}.seasons__year end as INT64) ;;
  }
